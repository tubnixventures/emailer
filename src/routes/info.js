...
/**
 * POST /emails/info
 * Sends general information or responses.
 * Requires: to, bodyMessage (plain text), subject
 */
export const postInfoEmail = async (c) => {
    ...
    // ONLY PASSING ATTRIBUTES: to, bodyMessage (expected as PLAIN TEXT), subject
    const { to, subject, bodyMessage, recipientName } = body;
    
    if (!to || !subject || !bodyMessage) {
        return c.json({ success: false, error: 'MISSING_FIELDS', message: 'Required fields: to, subject, and bodyMessage must be provided.', timestamp }, 400);
    }
    ...
    try {
        ...
        // Convert plain text newlines (\n) to HTML paragraphs for safe insertion.
...
<body>
    <div class="email-container">
        ...
        <div class="subject-container">
            <div class="info-tag">INFORMATIONAL</div>
        ...
        <div class="content">
            ...
            <div class="assistance-section">
                ...
                <p>Our team is here to help you with any questions or clarifications you may need.</p>
                
                <div class="contact-options">
                    <div class="contact-card">
                        <div class="contact-icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14 3H2C1.44772 3 1 3.44772 1 4V12C1 12.5523 1.44772 13 2 13H14C14.5523 13 15 12.5523 15 12V4C15 3.44772 14.5523 3 14 3Z" stroke="#1e3c72" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M1 4L8 8.5L15 4" stroke="#1e3c72" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div class="contact-title">Email Support</div>
                        <div class="contact-detail">info@housika.co.ke</div>
                    </div>
                    
                    <div class="contact-card">
                        <div class="contact-icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14 11V13C14 13.5304 13.7893 14.0391 13.4142 14.4142C13.0391 14.7893 12.5304 15 12 15H11.5C5.701 15 1 10.299 1 4.5V4C1 3.46957 1.21071 2.96086 1.58579 2.58579C1.96086 2.21071 2.46957 2 3 2H5C5.26522 2 5.51957 2.10536 5.70711 2.29289C5.89464 2.48043 6 2.73478 6 3V6.586C6 6.85122 5.89464 7.10557 5.70711 7.29311L4.414 8.586C5.30016 10.4591 6.79174 12.0374 8.672 13.101L9.707 11.707C9.89464 11.5196 10.149 11.4142 10.414 11.4142H14C14.2652 11.4142 14.5196 11.5196 14.7071 11.7071C14.8946 11.8946 15 12.149 15 12.4142V11Z" stroke="#1e3c72" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div class="contact-title">Phone & WhatsApp</div>
                        <div class="contact-detail">0745108505</div>
                    </div>
                </div>
            </div>
            ...
            <p class="info-note">This informational notice is designed to keep you updated and informed about important matters.</p>
            
            <div class="closing">
                <p>We're committed to keeping you informed and supported.</p>
                
                <div class="team-name">Housika Information Desk</div>
            </div>
        </div>
        ...
        const result = await zepto.sendMail({ 
            to, subject, htmlbody, recipientName: recipientName || 'Recipient',
        });
        return c.json({ success: true, message: 'Info email sent successfully.', result, timestamp }, 200);
    } catch (err) {
